  ...
  case $::osfamily {
    'Debian': {
      if ($docker::use_upstream_package_source) {
        ...
        $keyrings = [ 'debian-keyring', 'debian-archive-keyring' ]
        package { $keyrings:
          ensure => 'latest',
        }
        apt::source { 'docker':
...
root@node011:/etc/puppetlabs/code/environments/production/modules/docker/manifests# 
root@node011:/etc/puppetlabs/code/environments/production/modules/docker/manifests# cat repos.pp 
# == Class: docker::repos
#
#
class docker::repos {
